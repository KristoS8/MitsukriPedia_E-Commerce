<div class="bg-biru-muda-3-0 w-full relative pt-24 pb-12">
    <div
    ...
    <footer class="w-full grid">
        <ul class="mx-24 w-max py-8">
            <li class="mt-1">
        ...
        <div class="grid justify-items-center">
            <hr class="h-px mt-1 w-11/12 bg-gray-400 border-0 dark:bg-gray-700">
        </div>
        ...
        <div class="w-max flex place-self-end mx-12 gap-5 justify-center">
            ...
            <div class="bg-white p-2 rounded-2xl w-max flex items-center cursor-pointer">
                <img src="{{ asset('img/dana.png') }}" alt="" class="w-7 object-contain mix-blend-multiply">
                <p class="text-biru-utama-0 font-semibold text-sm mx-1">Dana</p>
            </div>
            <div class="bg-white p-2 rounded-2xl w-max flex items-center cursor-pointer">
                <img src="{{ asset('img/telkomsel.png') }}" alt=""
                    class="w-5 object-contain mix-blend-multiply">
                <p class="text-red-500 font-semibold text-xs mx-1">Telkomsel</p>
            </div>
        </div>
